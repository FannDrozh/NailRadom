...
public class Adapter extends BaseAdapter {
    ...
    private Bitmap getUserImage(String encodedImg)
    {
        ...
        else
        {
            ...
            return BitmapFactory.decodeResource(nContext.getResources(), R.drawable.logo);
        }
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView Name=v.findViewById(R.id.NameNail);
        TextView Price= v.findViewById(R.id.PriceNail);
        ImageView Image= v.findViewById(R.id.Photo);

        Mask mask=maskList.get(position);

        Name.setText(mask.getName());
        Price.setText(mask.getPrice());
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenDetalis=new Intent(nContext,FinalNail.class);
                intenDetalis.putExtra("RandomNail",mask);
